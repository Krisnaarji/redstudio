  ...
  export default function Porto() {
    ...
    return (
      <section id="porto" className="lg:py-10 pt-20 text-center overflow-hidden bg-black lg:min-h-screen mb-10 md:mb-10 lg:mb-0">
        ...
        <div className="relative w-full max-w-6xl mx-auto">
          ...
          >
            {loopedWorks.map((work, index) => (
              <div
                key={index}
                className="work-card flex-shrink-0 w-[300px] sm:w-[350px] lg:w-[400px] h-[360px] sm:h-[420px] lg:h-[420px] rounded-2xl overflow-hidden shadow-2xl relative group cursor-pointer transition-all duration-700"
                style={{
